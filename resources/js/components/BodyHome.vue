    ...
    <div class="container top">
        ...
        <div class="content mtop">
            <div class="owl-carousel owl-carousel1 owl-theme">
                <div class="items">
                    <div class="image">
                        <img src="images/Accommodation.png" alt="" height="260px">
                    </div>
                    <div class="text">
                ...
                <div class="items">
                    <div class="image">
                        <img src="images/accommodation4.jpg" alt="">
                    </div>
                    <div class="text">
                        <h2>Accommodation Room</h2>
                        <div class="rate flex">
    ...
    <div class="container top">
        ...
        <div class="content mtop">
            <div class="owl-carousel owl-carousel1 owl-theme">
                ...
                <div class="items">
                    <div class="img">
                        <img src="images/camping/camping3.jpg" alt="">
                    </div>
                    <div class="overlay">
                        <span class=" fa fa-plus"></span>
                        <h3>Photo Title Here.</h3>
                ...
                <div class="items">
                    <div class="img">
                        <img src="images/camping/camping2.jpg" alt="">
                    </div>
                    <div class="overlay">
                        <span class=" fa fa-plus"></span>
                        <h3>Photo Title Here.</h3>
                ...
                <div class="items">
                    <div class="img">
                        <img src="images/Hiking/Hiking.png" alt="">
                    </div>
                    <div class="overlay">
                        <span class=" fa fa-plus"></span>
                        <h3>Photo Title Here.</h3>
                ...
                <div class="items">
                    <div class="img">
                        <img src="images/Trekking/trekking2.jpg" alt="">
                    </div>
                    <div class="overlay">
                        <span class=" fa fa-plus"></span>
                        <h3>Photo Title Here.</h3>
