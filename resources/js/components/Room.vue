<template>
   <div>
      ...
      <section class="gallery3" id="gallery3">
      ...
      <section class="about" id="about" >
         ...
         <div class="row revers" style="color:white">
            <div class="image">
         ...
         <div class="row">
            ...
            <div class="content">
               <h3>Deluxe Family Tent</h3>
               <p>The wonderful selection of accommodation and elegantly decorated tent allows you to experience untamed,
