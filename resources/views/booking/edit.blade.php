...
@section('content')
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col-md-12 header-titile bg-light text-dark">
                        <h4><i class="fa-solid fa-pen-to-square"></i> Edit Booking</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form enctype="multipart/form-data" name="package-create-form" id="add-blog-post-form"
                        action="{{ url('/booking_update'.'/'. $package_booked->id) }}" method="post">
                        @csrf
                        <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group start-date">
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" value="{{ $package_booked->check_in_date}}" class="form-control form-control datetimepicker"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group end-date">
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" value="{{ $package_booked->check_out_date }}" class="form-control form-control datetimepicker"
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" value="{{$customer_infomation->name}}" class="form-control" placeholder="Name" name="name"
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="phone" value="{{$customer_infomation->phone}}" class="form-control" placeholder="phone"
    ...
    <script type="text/javascript">
        ...
        var room_id_arr = [];
        var tent_id_arr = [];
        const booking_id = {{$package_booked->id}};
        // console.log('booking_id', booking_id);
        // console.log(tent_data);
        $(document).ready(function() {
            $.ajax({
                type: "GET",
                url: '/get-room_id?id=' + booking_id,
                // data: room_id_arr,
