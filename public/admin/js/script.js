...
$(".sidebar-overlay").removeClass("opened");$('html').removeClass('menu-opened');});if($('.page-wrapper').length>0){var height=$(window).height();$(".page-wrapper").css("min-height",height);}
...
$(document).on('click','#toggle_btn',function(){
    if($('body').hasClass('mini-sidebar')){
        $('.logo-brand').css({"width": "90px","height": "70px", 
        "margin-left": "65px",
        "margin-bottom": "5px",
        "margin-top": "5px"})
    ...
    $('.logo-brand').css({"margin-left":"5px","width":"60px","height":"60px","margin-top":"10px"});
    $('.subdrop + ul').slideUp();}
